...
/**
 * Esta vista se usa para restablecer la contraseña
 * 
...
public class contraseñaOlvidada extends JFrame {
	...
	public contraseñaOlvidada() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(contraseñaOlvidada.class.getResource("/imagenes/olvidarPass.png")));
		...
		/**
		 * Botón que sirve para restablecer la clave
		 */
